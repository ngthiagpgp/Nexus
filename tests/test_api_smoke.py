...
class NexusApiSmokeTest(unittest.TestCase):
    def test_cockpit_root_serves_html_shell(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertIn('id="workspace-badge"', response.text)
            self.assertIn('id="readiness-bar"', response.text)
            self.assertIn('id="cycle-context-bar"', response.text)
            self.assertIn('id="main-nav"', response.text)
            self.assertIn('data-view="overview"', response.text)
            self.assertIn('data-view="map"', response.text)
            self.assertIn('data-view="flow"', response.text)
            self.assertIn('data-view="inspect"', response.text)
            self.assertIn('data-view="audit"', response.text)
            self.assertIn('rel="icon"', response.text)
            self.assertIn('id="overview-view"', response.text)
            self.assertIn('id="overview-grid"', response.text)
            self.assertIn('id="cycle-index"', response.text)
            self.assertIn('id="ontology-list"', response.text)
            self.assertIn('id="workspace-pulse"', response.text)
            self.assertIn('id="map-view"', response.text)
            self.assertIn('id="graph-stage"', response.text)
            self.assertIn('id="graph-world"', response.text)
            self.assertIn('id="map-field-controls"', response.text)
            self.assertIn('id="hover-probe"', response.text)
            self.assertIn('data-map-zoom="out"', response.text)
            self.assertIn('data-map-zoom="in"', response.text)
            self.assertIn('data-map-field="global"', response.text)
            self.assertIn('data-map-field="focused"', response.text)
            self.assertIn('data-map-depth="', response.text)
            self.assertIn('data-map-label-density="', response.text)
            self.assertIn('data-map-entity-filter="', response.text)
            self.assertIn('data-map-relation-filter="', response.text)
            self.assertIn('data-map-show-isolated', response.text)
            self.assertIn('data-map-advanced-toggle', response.text)
            self.assertIn('data-map-physics="', response.text)
            self.assertIn('data-map-node-size', response.text)
            self.assertIn('data-map-link-thickness', response.text)
            self.assertIn('data-map-freeze', response.text)
            self.assertIn('data-map-animate', response.text)
            self.assertIn('data-map-isolate', response.text)
            self.assertIn('data-map-reset', response.text)
            self.assertIn('id="map-legend"', response.text)
            self.assertIn('id="flow-view"', response.text)
            self.assertIn('id="flow-attention"', response.text)
            self.assertIn('id="flow-moving"', response.text)
            self.assertIn('id="flow-stable"', response.text)
            self.assertIn('id="flow-documents"', response.text)
            self.assertIn('id="inspect-view"', response.text)
            self.assertIn('id="inspect-object-title"', response.text)
            self.assertIn('id="inspect-context"', response.text)
            self.assertIn('id="inspect-evidence"', response.text)
            self.assertIn('id="inspect-governance"', response.text)
            self.assertIn('id="selected-primary"', response.text)
            self.assertIn('id="selected-secondary"', response.text)
            self.assertIn('id="technical-drawer"', response.text)
            self.assertIn('id="audit-view"', response.text)
            self.assertIn('id="audit-timeline"', response.text)
            self.assertIn('id="document-strip"', response.text)
            self.assertIn('id="audit-snapshot"', response.text)
            self.assertIn("Institutional supervision surface", response.text)
            self.assertIn("Cycle Index", response.text)
            self.assertIn("Structural Context", response.text)
            self.assertIn("Workspace Pulse", response.text)
            self.assertIn("Scan the current operational frame", response.text)
            self.assertIn("A shared operational substrate for human and agent work.", response.text)
            self.assertIn("Read the workspace as a living institutional map.", response.text)
            self.assertIn("Move from focused cycle to immediate action.", response.text)
            self.assertIn("Judge the selected object through context, evidence, and governance.", response.text)
            self.assertIn("Reconstruct the institutional memory of the workspace.", response.text)
            ...
            self.assertIn("/api/relations", response.text)
